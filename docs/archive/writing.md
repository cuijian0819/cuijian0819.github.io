...
title: Writing · Jian Cui
description: A collection of insights, tips, and rules of thumb on academic writing that resonate with Jian Cui.
---
...
_"What a man (today we would say man or woman) knows or what a man thinks is lost if he can not express it through oratory or writing."_
...
- **Break unnecessary rules when needed**:
  ...
  - Churchill's example: "That kind of nonsense up with which I refuse to put" (_put up with_ is more natural but breaks the rule)
